...
;(function (h) {
        ...
        for (g = q.length; f < g; f++) {
          if (typeof q[f] === 'number' && q[f] >= 0) {
            ...
            for (i = l.length; j < i; j++) {
              ;(q[f] == '_all' || h(l[j].nTh).hasClass(q[f])) && d(j, m)
            }
          }
        }
      }
  ...
  function wb (a, b, c, d, e, f) {
    ...
    if (b.length <= 0) a.aiDisplay = g.slice()
      ...
      if (j || c || f.length > b.length || b.indexOf(f) !== 0 || a.bSorted) {
        a.aiDisplay = g.slice()
      }
      b = a.aiDisplay
  ...
  function Fa (a) {
    ...
    if (d || (!t && !f && !e && j == V(a) && j == m.length)) {
      for (n = 0; n < j; n++) {
        ;(i = aa(a, n)), i !== null && (c[i].sWidth = v(m.eq(n).width()))
      }
    } else {
      j = h(b)
        .clone()
    ...
    ac = function (a) {
      ...
      if (a) {
        ...
        if (a.nodeName && a.nodeName.toLowerCase() === 'table') {
          return (b = h.inArray(a, e)), b !== -1 ? [d[b]] : null
        }
