    ...
    _default: {
      get: function (e) {
        ...
        return e.elem.nodeType !== 1 ||
          ...
          ? e.elem[e.prop]
          : (t = w.css(e.elem, e.prop, '')) && t !== 'auto' ? t : 0
      },
      set: function (e) {
        w.fx.step[e.prop]
          ? w.fx.step[e.prop](e)
          ...
          : ((o === 1 && w.isXMLDoc(e)) ||
            ...
            void 0 !== n
              ...
              : i && 'get' in i && (r = i.get(e, t)) !== null
                ? r
                : (r = w.find.attr(e, t)) == null ? void 0 : r)
      }
    },
    attrHooks: {
      type: {
        ...
        return (
          ...
          void 0 !== n
            ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
              ? r
              : (e[t] = n)
            : i && 'get' in i && (r = i.get(e, t)) !== null ? r : e[t]
        )
      }
    },
    propHooks: {
...
;(function (h) {
  ...
  function Ca (a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable &&
        (d && b.sEmptyTable === 'No data available in table') &&
        F(a, a, 'sZeroRecords', 'sEmptyTable')
      !a.sLoadingRecords &&
        (d && b.sLoadingRecords === 'Loading...') &&
  ...
  function fb (a) {
    ...
    var b = a.aDataSort
    typeof b === 'number' && !h.isArray(b) && (a.aDataSort = [b])
  }
  function gb (a) {
    if (!n.__browser) {
      var b = {}
      ...
      for (e = b.length - 1; e >= 0; e--) {
        ...
        for (g = q.length; f < g; f++) {
          if (typeof q[f] === 'number' && q[f] >= 0) {
            ...
            d(q[f], m)
          } else if (typeof q[f] === 'number' && q[f] < 0) d(l.length + q[f], m)
          else if (typeof q[f] === 'string') {
            j = 0
            for (i = l.length; j < i; j++) { (q[f] == '_all' || h(l[j].nTh).hasClass(q[f])) && d(j, m) }
          }
        }
      }
    }
  ...
  function da (a, b, c, d) {
    ...
    if (c === 'dom' || ((!c || c === 'auto') && e.src === 'dom')) { e._aData = Ia(a, e, d, d === k ? k : e._aData).data } else {
      var j = e.anCells
      if (j) {
        if (d !== k) g(j[d], d)
        else {
    ...
    for (var f = a.sDom.split(''), g, j, i, m, l, q, k = 0; k < f.length; k++) {
      ...
      if (j == '<') {
        ...
        if (m == "'" || m == '"') {
          ...
          l == 'H' ? (l = b.sJUIHeader) : l == 'F' && (l = b.sJUIFooter)
          ;l.indexOf('.') != -1
            ? ((m = l.split('.')),
      ...
      else if (j == 'l' && d.bPaginate && d.bLengthChange) g = ob(a)
      else if (j == 'f' && d.bFilter) g = pb(a)
      else if (j == 'r' && d.bProcessing) g = qb(a)
      else if (j == 't') g = rb(a)
      else if (j == 'i' && d.bInfo) g = sb(a)
      else if (j == 'p' && d.bPaginate) g = tb(a)
      else if (n.ext.feature.length !== 0) {
        i = n.ext.feature
        q = 0
  ...
  function sa (a, b, c) {
    ...
    if (h.isPlainObject(g) && g.data) {
      f = g.data
      var m = typeof f === 'function' ? f(b, a) : f,
        b = typeof f === 'function' && m ? m : h.extend(!0, b, m)
      delete g.data
    }
    m = {
      data: b,
  ...
  function ub (a) {
    ...
    for (g = 0; g < c; g++) {
      (m = b[g]),
      (l = f[g]),
      (i = typeof m.mData === 'function' ? 'function' : m.mData),
      G.columns.push({
        data: i,
        name: m.sName,
  ...
  function pb (a) {
    var b = a.oClasses,
      ...
      g = a.searchDelay !== null ? a.searchDelay : y(a) === 'ssp' ? 400 : 0,
      i = h('input', b)
        .val(e.sSearch)
  ...
  function wb (a, b, c, d, e, f) {
    var d = Pa(b, d, e, f),
      ...
      j,
      e = []
    n.ext.search.length !== 0 && (c = !0)
    j = zb(a)
    if (b.length <= 0) a.aiDisplay = g.slice()
    else {
      if (j || c || f.length > b.length || b.indexOf(f) !== 0 || a.bSorted) { a.aiDisplay = g.slice() }
      b = a.aiDisplay
  ...
  function la (a) {
    ...
    if (a.scrollBarVis !== L && a.scrollBarVis !== k) (a.scrollBarVis = L), $(a)
      ...
      if (p.outerWidth() < f) {
        Q =
          j.scrollHeight > j.offsetHeight || l.css('overflow-y') == 'scroll'
            ? f + b
            : f
        if (
          U &&
      ...
      m[0].style.width = v(c)
      i.width = v(c)
      d = p.height() > j.clientHeight || l.css('overflow-y') == 'scroll'
  ...
  function Fa (a) {
    var b = a.nTable,
      ...
      p = a.oBrowser,
      d = p.bScrollOversize
    ;(n = b.style.width) && n.indexOf('%') !== -1 && (l = n)
    for (n = 0; n < i.length; n++) {
      (o = c[i[n]]),
      o.sWidth !== null && ((o.sWidth = Eb(o.sWidthOrig, k)), (t = !0))
    }
    if (d || (!t && !f && !e && j == V(a) && j == m.length)) {
      for (n = 0; n < j; n++) { (i = aa(a, n)), i !== null && (c[i].sWidth = v(m.eq(n).width())) }
    } else {
      j = h(b)
        .clone()
  ...
  function wa (a) {
    ...
    if (e.bSort && e.bSortClasses) {
      ...
      for (f = b.length; e < f; e++) {
        (g = b[e].src),
        h(D(a.aoData, 'anCells', g)).removeClass(c + (e < 2 ? e + 1 : 3))
      }
      e = 0
      for (f = d.length; e < f; e++) {
        (g = d[e].src),
        h(D(a.aoData, 'anCells', g)).addClass(c + (e < 2 ? e + 1 : 3))
      }
    }
    a.aLastSort = d
  }
  ...
  var n = function (a) {
      ...
      this.each(function () {
        var e = {},
          ...
          l = n.defaults,
          q = h(this)
        if (this.nodeName.toLowerCase() != 'table') { K(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2) } else {
          eb(l)
          fb(l.column)
          J(l, l, !0)
          ...
          if (e === null || e === '') { this.id = e = 'DataTables_Table_' + n.ext._unique++ }
          ...
          t.length !== 0 && (ea(p.aoHeader, t[0]), (e = ra(p)))
          if (g.aoColumns === null) {
            t = []
            j = 0
  ...
  var A = function (a, b, c) {
    ...
    ac = function (a) {
      ...
      if (a) {
        ...
        if (a.nodeName && a.nodeName.toLowerCase() === 'table') { return (b = h.inArray(a, e)), b !== -1 ? [d[b]] : null }
  ...
  h.extend(s.prototype, {
    ...
    iterator: function (a, b, c, d) {
      var e = [],
        ...
        o,
        u = this.selector
      typeof a === 'string' && ((d = c), (c = b), (b = a), (a = !1))
      g = 0
      for (j = l.length; g < j; g++) {
        var r = new s(l[g])
        if (b === 'table') (f = c.call(r, l[g], g)), f !== k && e.push(f)
        else if (b === 'columns' || b === 'rows') { (f = c.call(r, l[g], this[g], g)), f !== k && e.push(f) } else if (
          b === 'column' ||
          b === 'column-rows' ||
          b === 'row' ||
          b === 'cell'
  ...
  o('draw()', function (a) {
    return this.iterator('table', function (b) {
      a === 'page'
        ? P(b)
        : (typeof a === 'string' && (a = a === 'full-hold' ? !1 : !0),
          T(b, !1 === a))
    })
  })
  o('page()', function (a) {
  ...
  o('page.len()', function (a) {
    return a === k
      ? this.context.length !== 0 ? this.context[0]._iDisplayLength : k
      : this.iterator('table', function (b) {
        Ra(b, a)
      })
  })
  ...
  var ab = function (a, b, c, d, e) {
      ...
      for (m = b.length; i < m; i++) {
        ...
        for (n = j.length; l < n; l++) {
          (g = c(typeof j[l] === 'string' ? h.trim(j[l]) : j[l])) &&
            g.length &&
            (f = f.concat(g))
        }
      }
    ...
    Ba = function (a, b) {
      ...
      c = b.order
      d = b.page
      if (y(a) == 'ssp') return j === 'removed' ? [] : Y(0, e.length)
      if (d == 'current') {
        c = a._iDisplayStart
    ...
    this.iterator('row', function (b, c, d) {
      ...
      for (h = e.length; g < h; g++) {
        if (
          ((i = e[g]),
            (l = i.anCells),
            i.nTr !== null && (i.nTr._DT_RowIndex = g),
            l !== null)
        ) {
          i = 0
  ...
  o('row().child()', function (a, b) {
    ...
    if (!0 === a) this.child.show()
      ...
      var d = c[0],
        ...
        e = [],
        f = function (a, b) {
          if (h.isArray(a) || a instanceof h) { for (var c = 0, k = a.length; c < k; c++) f(a[c], b) } else {
            a.nodeName && a.nodeName.toLowerCase() === 'tr'
              ? e.push(a)
  ...
  o('column.index()', function (a, b) {
    if (this.context.length !== 0) {
      ...
      if (a === 'fromVisible' || a === 'toData') return aa(c, b)
      if (a === 'fromData' || a === 'toVisible') return ba(c, b)
    }
  })
  ...
  o('search()', function (a, b, c, d) {
    var e = this.context
    return a === k
      ? e.length !== 0 ? e[0].oPreviousSearch.sSearch : k
  ...
  n.models.oSettings = {
    ...
    fnDisplayEnd: function () {
      ...
      return e.bServerSide
        ? !1 === f || a === -1 ? b + d : Math.min(b + a, this._iRecordsDisplay)
        : !f || c > d || a === -1 ? d : c
    },
    oInstance: null,
    sInstance: null,
  ...
  h.extend(n.ext.type.search, {
    html: function (a) {
      return M(a)
        ? a
        : typeof a === 'string' ? a.replace(Mb, ' ').replace(Aa, '') : ''
    },
    string: function (a) {
      return M(a) ? a : typeof a === 'string' ? a.replace(Mb, ' ') : a
    }
  })
          ...
          if (((c = f[l]), b.isArray(c))) q(d, c)
            ...
            e &&
              ((i = b('<li>', {
                ...
                id:
                  r === 0 && typeof c === 'string' ? a.sTableId + '_' + c : null
              })
                .append(
                  b('<a>', {
                    href: '#',
