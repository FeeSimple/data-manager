 ...
 */ ;(function (
  ...
  function a (e) {
    ...
    if (i === 'BODY' || i === 'HTML') {
      ...
      var r = e.ownerDocument.scrollingElement || n
      return r[o]
    }
    return e[o]
  }
  ...
  function u (e, o) {
    ...
    var f = parseFloat(a.borderTopWidth, 10)

    var m = parseFloat(a.borderLeftWidth, 10)
    ...
    if (((h.marginTop = 0), (h.marginLeft = 0), !i && r)) {
      ...
      var b = parseFloat(a.marginLeft, 10)
      ;(h.top -= f - u),
      (h.bottom -= f - u),
      (h.left -= m - b),
      (h.right -= m - b),
  ...
  function b (e) {
    ...
    var i = J(t.clientWidth, window.innerWidth || 0)

    var n = J(t.clientHeight, window.innerHeight || 0)
  ...
  function L (e) {
    ...
    var n = { width: e.offsetWidth + i, height: e.offsetHeight + o }
    return n
  }
  function x (e) {
  ...
  function S (e, t, o) {
    ...
    var n = { width: i.width, height: i.height }
  ...
  function H (e, t, o, i) {
    ...
    var p = r ? e.ownerDocument.defaultView : e
      ...
      modifiers: {
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            var a = void 0 === p ? t.gpuAcceleration : p

            var l = r(e.instance.popper)

            var f = g(l)

            var m = { position: n.position }
