...
!(function (t, e) {
  ...
  var j = (function (t) {
    ...
    var m = 'carousel-item-right'

    var v = 'carousel-item-left'

    var E = 'carousel-item-next'

    var T = 'carousel-item-prev'
    ...
    var C = (function () {
      ...
      return (
        ...
        (C._triggerSlideEvent = function (e, n) {
          ...
          var s = this._getItemIndex(t(this._element).find(y.ACTIVE_ITEM)[0])

          var r = t.Event(d.SLIDE, {
            relatedTarget: e,
            direction: n,
            from: s,
            to: i
        ...
        (C._slide = function (e, n) {
          ...
          var a = t(this._element).find(y.ACTIVE_ITEM)[0]
        ...
        (o._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            var s = r({}, a, t(this).data())
            typeof e === 'object' && (s = r({}, s, e))
            var l = typeof e === 'string' ? e : s.slide
            if (
  ...
  var H = (function (t) {
    ...
    var a = { toggle: !0, parent: '' }

    var l = { toggle: 'boolean', parent: '(string|element)' }
    ...
    var m = (function () {
      function i (e, n) {
        ...
        for (var i = t(p.DATA_TOGGLE), s = 0; s < i.length; s++) {
          ...
          var o = P.getSelectorFromElement(r)
          o !== null &&
      ...
      return (
        ...
        (i._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            var l = r({}, a, s.data(), typeof e === 'object' && e)
            if (
  ...
  var W = (function (t) {
    ...
    var p = 'dropdown-menu-right'

    var m = 'dropdown-menu-left'

    var v = 'position-static'
    ...
    var I = '.dropdown-menu .dropdown-item:not(.disabled)'
    ...
    var O = { offset: 0, flip: !0, boundary: 'scrollParent' }
      ...
      return (
        (l.toggle = function () {
          if (!this._element.disabled && !t(this._element).hasClass(u)) {
            ...
            var i = t(this._menu).hasClass(f)
            if ((a._clearMenus(), !i)) {
              var s = { relatedTarget: this._element }

              var r = t.Event(c.SHOW, s)
  ...
  var M = (function (t) {
    ...
    var a = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }
    ...
    var c = 'modal-scrollbar-measure'

    var u = 'modal-backdrop'
    ...
    var p = (function () {
      ...
      return (
        ...
        (p._showElement = function (e) {
          ...
          var i = P.supportsTransitionEnd() && t(this._element).hasClass(d)
        ...
        (p._showBackdrop = function (e) {
          ...
          var i = t(this._element).hasClass(d) ? d : ''
        ...
        (p._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            ...
            var i = t('body').css('padding-right')
            t('body')
    ...
    return (
      t(document).on(h.CLICK_DATA_API, g.DATA_TOGGLE, function (e) {
        ...
        var o = P.getSelectorFromElement(this)
        o && (i = t(o)[0])
  ...
  var U = (function (t) {
    ...
    var l = new RegExp('(^|\\s)bs-tooltip\\S+', 'g')
      ...
      return (
        ...
        (I.toggle = function (e) {
          if (this._isEnabled) {
            if (e) {
              ...
              var i = t(e.currentTarget).data(n)
              i ||
        ...
        (I.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            var o = P.getUID(this.constructor.NAME)
            r.setAttribute('id', o),
        ...
        (I.hide = function (e) {
          ...
          var s = t.Event(this.constructor.Event.HIDE)
  ...
  var x = (function (t) {
    ...
    var a = new RegExp('(^|\\s)bs-popover\\S+', 'g')
    ...
    var h = r({}, U.DefaultType, { content: '(string|element|function)' })

    var c = 'fade'

    var u = 'show'

    var f = '.popover-header'
    ...
    var g = (function () {
      ...
      return (
        (g.refresh = function () {
          ...
          var n = this._scrollElement === this._scrollElement.window ? d : _

          var i = this._config.method === 'auto' ? n : this._config.method

          var s = i === _ ? this._getScrollTop() : 0
              ;(this._offsets = []),
          (this._targets = []),
          ...
          t
            ...
            .map(function (e) {
              ...
              var r = P.getSelectorFromElement(e)
              if ((r && (n = t(r)[0]), n)) {
  ...
  var V = (function (t) {
    ...
    var f = '.nav, .list-group'

    var d = '.active'

    var _ = '> li > .active'

    var g = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]'

    var p = '.dropdown-toggle'

    var m = '> .dropdown-menu .active'
      ...
      return (
        (i.show = function () {
          ...
          if (
            ...
            var s = t(this._element).closest(f)[0]

            var o = P.getSelectorFromElement(this._element)
            if (s) {
              var h = s.nodeName === 'UL' ? _ : d
              i = (i = t.makeArray(t(s).find(h)))[i.length - 1]
            }
            var c = t.Event(r.HIDE, { relatedTarget: this._element })

            var u = t.Event(r.SHOW, { relatedTarget: i })
            if (
              (i && t(i).trigger(c),
              ...
              var g = function () {
                ...
                var s = t.Event(r.SHOWN, { relatedTarget: i })
        ...
        (i._activate = function (e, n, i) {
          ...
          var r = (n.nodeName === 'UL' ? t(n).find(_) : t(n).children(d))[0]

          var o = i && P.supportsTransitionEnd() && r && t(r).hasClass(h)
