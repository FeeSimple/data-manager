      ...
      <ListGroup>
        ...
        <ListGroupItem>
          <Row>
            ...
            <Col>
              <h3 className='user-detail-label'>{user.created}</h3>
            </Col>
          </Row>
        </ListGroupItem>
        <ListGroupItem>
          <Row>
            ...
            <Col>
              <h3 className='user-detail-label'>{user.balance}</h3>
            </Col>
          </Row>
        </ListGroupItem>
        <ListGroupItem>
          <Row id='TooltipRam'>
            <Col>
              ...
              <Button size='sm' onClick={handleToggleModalRam}>
                Buy/Sell
              </Button>
            </Col>
            <Col>
            ...
            <UncontrolledTooltip
              ...
              styleName='tooltip'
            >
              <p>RAM needs to be staked (with XFS coins)</p>
              <p>for creating/editing/deleting the property.</p>
            </UncontrolledTooltip>
          </Row>
        </ListGroupItem>
        <ListGroupItem>
          <Row id='TooltipCpu'>
            <Col>
              ...
              <Button size='sm' onClick={handleToggleModalCpu}>
                Stake/Unstake
              </Button>
            </Col>
            <Col>
            ...
            <UncontrolledTooltip
              ...
              styleName='tooltip'
            >
              <p>CPU needs to be staked (with XFS coins)</p>
              <p>for creating/editing/deleting the property.</p>
            </UncontrolledTooltip>
          </Row>
        </ListGroupItem>
        <ListGroupItem>
          <Row id='TooltipBandwidth'>
            <Col>
              ...
              <Button size='sm' onClick={handleToggleModalBw}>
                Stake/Unstake
              </Button>
            </Col>
            <Col>
              <div className='user-detail-label-small'>
                ...
                {user.unstakedBandwidth ? (
                  <span>
                    &nbsp; &nbsp; &nbsp; (Unstaked: {user.unstakedBandwidth})
                  </span>
                ) : (
                  <span />
                )}
            ...
            <UncontrolledTooltip
              placement='left'
              target='TooltipBandwidth'
              styleName='tooltip'
            >
              <p>Bandwidth needs to be staked (with XFS coins)</p>
              <p>for viewing the property.</p>
            </UncontrolledTooltip>
          </Row>
        </ListGroupItem>
      </ListGroup>
